...
export default function PostCard({
  ...
  return (
    <Link href={`/${slug}`}>
      <article className="mx-auto flex max-w-[25rem] flex-col overflow-hidden rounded-xl shadow-lg shadow-gray-400 transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl">
